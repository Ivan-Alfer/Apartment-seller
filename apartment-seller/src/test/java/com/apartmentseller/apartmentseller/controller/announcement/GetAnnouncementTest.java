...
public class GetAnnouncementTest {
    ...
    public void showForUser() throws Exception {
        mockMvc.perform(get("/announcement/2").header("X-Auth-Token", "eyJhbGciOiJIUzUxMiJ9.eyJqdGkiOiJhIiwiZXhwIjoxNTU5Mzg5NDgxfQ.uGAgxH2AumSyak5Ir0nRChRt8HRQGaNvAuFhFeSs5x7HmtwB7qy60yfT5c7J9DBrd0lXXrVMOq-tyjbw3qYPXQ"))
                .andDo(print())
    ...
    public void showForAnon() throws Exception {
        mockMvc.perform(get("/announcement/3"))
                .andDo(print())
                .andExpect(status().isOk());
    }
    ...
    public void notFound() throws Exception {
        mockMvc.perform(get("/announcement/23"))
                .andDo(print())
